codeunit 50139 EventSubscriptions
{
    ...
    local procedure ExtendNavigateOnAfterNavigateShowRecords(TableID: Integer; DocNoFilter: Text; PostingDateFilter: Text; var TempDocumentEntry: Record "Document Entry");
    var
        SeminarLedgerEntry: Record "CSD Seminar Ledger Entry";
        PostedSeminarRegHeader: Record "CSD Posted Seminar Reg. Header";
    begin
            ...
            Database::"CSD Posted Seminar Reg. Header":
                begin
                    ...
                    if TempDocumentEntry."No. of Records" = 1 then
                        page.Run(Page::"CSD Posted Seminar Reg.")
                    else
